      ...
      <div className="relative z-10 flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="backdrop-blur-xl bg-white/80 border border-white rounded-[2.5rem] shadow-2xl p-8 lg:p-10 transition-all hover:shadow-blue-500/10">
            ...
            <p className="text-slate-500 text-base font-medium mb-8">Start analyzing contracts for free</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-slate-700 text-xs font-bold uppercase tracking-widest mb-2">Full Name</label>
              ...
              >
                {loading ? (
                  ...
                  <><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" /></svg> Create Free Account</>
                )}
              </button>
            </form>
            ...
            <p className="mt-8 text-center text-sm text-slate-500 font-medium">
              ...
              <Link to="/signin" className="text-blue-600 hover:text-blue-700 font-black transition-colors underline decoration-blue-600/30 underline-offset-4">
                Sign in →
              </Link>
            </p>
          </div>
