...
function SignIn() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      />
      {/* Deep gradient overlay for better contrast */}
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-indigo-100 tracking-tight drop-shadow-sm">LegalEase</h1>
            <p className="text-blue-400/80 text-xs font-black uppercase tracking-[0.3em] mt-2">AI Contract Risk Analyzer</p>
          </div>

          {/* Glass card */}
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-1">Welcome back</h2>
            <p className="text-white/50 text-sm mb-7">Sign in to analyze your contracts</p>
